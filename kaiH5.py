...
def genName(bStr, i, j, k, Ri, Rj, Rk, nRes=None):
	...
	Args:
		...
		i (int): The value of i for this segment.
		j (int): The value of j for this segment.
		k (int): The value of k for this segment.
		Ri (int): The value of Ri for the overall decomposition.
		Rj (int): The value of Rj for the overall decomposition.
		Rk (int): The value of Rk for the overall decomposition.
		nRes (int, optional): The value of nRes for restart. Defaults to None.
