...
def create_command_line_parser():
    ...
    parser.add_argument(
        "-q", "--quiver", action="store_true", default=False,
        help="Add quiver plot of dB (default: %(default)s)."
    )
...
if __name__ == "__main__":
    ...
    topole  = ccrs.Orthographic(-90,90)
    ...
    if (doQuiv):
        ...
        V = -dB_t
        nSk = 2
        AxM.quiver(LonC[::nSk],LatC[::nSk],U[::nSk,::nSk],V[::nSk,::nSk],alpha=0.5,transform=toplate)
